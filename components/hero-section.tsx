...
>
  ...
  <div>
    <motion.h1
      ...
      className="max-w-3xl text-balance font-heading text-4xl font-extrabold leading-[1.05] tracking-tight text-white sm:text-5xl lg:text-6xl"
    >
    ...
    <motion.p
      ...
      className="mt-4 max-w-3xl text-balance font-heading text-2xl font-semibold leading-[1.2] tracking-wide text-white/90 sm:text-3xl"
    >
